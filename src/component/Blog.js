                    ...
                    <div className="pageContenSide">
                        <div className="postWrapperLeft">
                            ...
                            .map((schedule, index)=> {
                                ...
                                {schedule.link !== null ?
                                <div className="linkIcon"><UrlShare /></div>
                                :
                                null
                                }
                                {schedule.instgram_link === 1 && <a href={schedule.link} target={"_blank"}><Insta/></a>}
                                {schedule.facebook_link === 1 && <a href={schedule.FaceBook} target={"_blank"}><FaceBook/></a>}
                                {schedule.blog_link === 1 && <a href={schedule.blog_link} target={"_blank"}><BlogShare/></a>}
                                </div>
                                </div>
