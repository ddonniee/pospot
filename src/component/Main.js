                    ...
                    <div className="main">
                        <div className="contents wide"> 
                            ...
                            <div className="section2 scroll moHidden"  id="txt1section">
                                ...
                                <div className="imgDiv"> <History/> </div>
                            </div>
                                ...
                                <div className="img">
                                    ...
                                    {getLogList.map((data, index) => (
                                            ...
                                            {/* <div className="content-pic" onClick={()=>this.openPop(data)}> */}
                                                <div className="pic"><img key={"content-pic"+index} src={config.IMG_PATH+data.img_path1} onClick={()=>this.openPop(data)}/></div>
                                                {
                                                    {
                                    ...
                                    {/* 대웅 */}
                                     ...
                                     <ul className="content-list-mo">                                    
                                     {
                                        getLogList.map((data, index) => (
                                            ...
                                            null
                                            :
                                            <li className="content-box" key={"content-box"+index}>
                                            <div className="content-pic" onClick={()=>this.openPop(data)}>
