                            ...
                            <div className="popup lPop" onClick={(e)=>e.stopPropagation()}>
                                ...
                                <div className="logPop">
                                        ...
                                        >
                                            ...
                                            <div>
                                                ...
                                                <img key={`img_path`+index} src={config.IMG_PATH+img.path} style={{
                                                    padding:`window.innerwidth-16px`
                                                }}/> 
                                                :
                                                <img key={`img_path`+index} src={config.IMG_PATH+img.path} style={{
                                                    padding: "none",
                                    ...
                                    <ul className="linkToSocial">
                                        ...
                                        <li className="LinksocialList" value="1" onClick={()=>viewlink3(this.state.popData.link)}><Share/></li>
                                        :
                                        null }
                                        {this.state.popData.blog_link === 0 ?
                                        null :
                                        <a href={this.state.popData.blog_link} target="_blank"><li className="LinksocialList"><Blog/></li></a>
                                        }
                                        ...
                                        null :
                                        <a href={this.state.popData.instagram_link} target="_blank"><li className="LinksocialList"><Insta/></li></a>
                                        }
